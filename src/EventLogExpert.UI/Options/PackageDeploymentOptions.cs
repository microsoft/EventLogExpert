...
///     Allows updating from any version of the package, even if it would be a
///     downgrade.
/// </param>
/// <param name="ForceTargetAppShutdown">Forces the target application to shut down before the update is applied.</param>
/// <param name="DeferRegistrationWhenPackagesAreInUse">
///     Defers the package registration until the application is no longer
///     in use.
/// </param>

...
internal static class EventLogDataExtensions
{
    ...
    {
        /// <summary>
        ///     Returns ENVELOPE bounds across the supplied logs: <c>After</c> is the oldest event timestamp and <c>Before</c>
        ///     is the newest. <c>After</c> is floored to the nearest hour and <c>Before</c> is ceilinged so the rounded range
        ///     fully contains every event.
        /// </summary>
        /// <remarks>

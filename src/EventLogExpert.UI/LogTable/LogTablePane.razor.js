...
export function initializeTableEvents(ref) {
    disposeTableEvents();
...
export function disposeTableEvents() {
    if (controller) {
        controller.abort();
        controller = null;
    }
...
export function refreshColumnResize() {
    const table = document.getElementById("eventTable");
...
export function getEventTablePageSize() {
    const table = document.getElementById("eventTable");
...
export function focusEventTableRow(index) {
    const table = document.getElementById("eventTable");

...
public class MessageModel
{
    ...
    /// <summary>The short ID - only the two low bytes of the raw ID</summary>
    public short ShortId { get; set; }

    /// <summary>
    ///     Arbitrary tag that can be set by the caller. We use this to distinguish between the same messages retrieved
    ///     from different computers (for example, from different versions of Windows or applications such as Exchange Server).
    /// </summary>
    public string? Tag { get; set; }

    /// <summary>Some providers may include an XML template that describes the included properties.</summary>

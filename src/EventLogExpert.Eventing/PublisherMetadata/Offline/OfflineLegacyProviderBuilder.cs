...
///     parse succeeds). Resolution goes through <see cref="ILegacyMessageFileResolver" /> and
...
/// </summary>
internal sealed class OfflineLegacyProviderBuilder(ILegacyMessageFileResolver legacyResolver, ITraceLogger? logger)
{

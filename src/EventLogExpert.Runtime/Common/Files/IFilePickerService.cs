...
public interface IFilePickerService
{
    ...
    /// </summary>
    Task<string?> PickAsync(string pickerTitle, IReadOnlyList<string> extensions, string? initialDirectory = null);
    ...
    /// </summary>
    Task<IReadOnlyList<string>> PickMultipleAsync(string pickerTitle, IReadOnlyList<string> extensions, string? initialDirectory = null);

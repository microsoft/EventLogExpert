...
/// <summary>
///     Fluxor configuration helpers that own the EventLogExpert.Runtime assembly identity. The host project calls
...
{
    /// <summary>
    ///     Adds the EventLogExpert.Runtime assembly to <paramref name="options" />'s scan list. Chainable with other

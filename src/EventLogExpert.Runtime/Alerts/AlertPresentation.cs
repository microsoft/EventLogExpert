...
public enum AlertPresentation
{
    ...
    /// <summary>Require an active inline alert host. Throws <see cref="InvalidOperationException" /> if none is registered.</summary>
    InlineOnly,

    /// <summary>Always open a standalone popup, even if an inline host is registered.</summary>
    PopupOnly,
}

...
/// <summary>
///     Immutable description of a single entry in a menu (menu bar dropdown, context menu, or submenu). Used by the
///     data-driven MenuRenderer; pair instances via <see cref="Children" /> or <see cref="ChildrenLoader" /> to build
///     trees.
/// </summary>
public sealed record MenuItem
{
    ...
    /// <summary>
    ///     <c>null</c> for non-checkable items; <c>true</c>/<c>false</c> for checkable items so screen readers can
    ///     announce the toggle state via <c>role="menuitemcheckbox"</c> + <c>aria-checked</c>.
    /// </summary>

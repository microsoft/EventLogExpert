...
internal sealed class DatabaseToolsService : IDatabaseToolsService
{
    public Task<DatabaseToolsResult> ShowAsync(
        ...
        => RunAsync(new ShowProvidersOperation(request), logSink, progress, cancellationToken);
    ...
    public Task<DatabaseToolsResult> CreateAsync(
        ...
        IProgress<DatabaseToolsProgress>? progress,
        CancellationToken cancellationToken)
        => RunAsync(new CreateDatabaseOperation(request), logSink, progress, cancellationToken);
    ...
    public Task<DatabaseToolsResult> MergeAsync(
        ...
        IProgress<DatabaseToolsProgress>? progress,
        CancellationToken cancellationToken)
        => RunAsync(new MergeDatabaseOperation(request), logSink, progress, cancellationToken);
    ...
    public Task<DatabaseToolsResult> DiffAsync(
        ...
        IProgress<DatabaseToolsProgress>? progress,
        CancellationToken cancellationToken)
        => RunAsync(new DiffDatabaseOperation(request), logSink, progress, cancellationToken);
    ...
    public Task<DatabaseToolsResult> UpgradeAsync(
        ...
        IProgress<DatabaseToolsProgress>? progress,
        CancellationToken cancellationToken)
        => RunAsync(new UpgradeDatabaseOperation(request), logSink, progress, cancellationToken);

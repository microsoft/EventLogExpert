...
public sealed class PublisherMetadataHandleTests
{
    [Fact]
    ...
    {
        using PublisherMetadataHandle? metadata = PublisherMetadataHandle.Create(providerName);
    ...
    public void Create_WhenEmptyProviderName_ShouldNotLogError()
    {
        ...
        using PublisherMetadataHandle? metadata = PublisherMetadataHandle.Create(string.Empty, logger: mockLogger);
    ...
    {
        using PublisherMetadataHandle? metadata = PublisherMetadataHandle.Create(string.Empty);
    ...
    public void Create_WhenInvalidProvider_ShouldLogError()
    {
        ...
        using PublisherMetadataHandle? metadata = PublisherMetadataHandle.Create(providerName, logger: mockLogger);
    ...
    {
        using PublisherMetadataHandle? metadata = PublisherMetadataHandle.Create("Invalid<>Provider|Name");
    ...
    public void Create_WhenValidProvider_ShouldNotLogError()
    {
        ...
        using PublisherMetadataHandle? metadata = PublisherMetadataHandle.Create(Constants.SecurityAuditingLogName, logger: mockLogger);
    ...
    {
        using PublisherMetadataHandle? metadata = PublisherMetadataHandle.Create("   ");
    ...
    {
        using PublisherMetadataHandle? metadata = PublisherMetadataHandle.Create(Constants.PowerShellLogName);

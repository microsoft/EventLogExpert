...
namespace EventLogExpert.Eventing.IntegrationTests.ProviderMetadata.Wevt;
        ...
        IClassFixture<OfflineWevtProviderParityTests.PerfOsParityFixture>
{
    ...
    {
        (ProviderParityFixture Fixture, string Label)[] sample =
        [

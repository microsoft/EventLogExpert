...
/// <summary>
///     Validates <see cref="EventFilter.RequiresXml" /> aggregation across filters. This flag drives selective log
///     reloads in <c>Effects.HandleSetFilters</c>; false positives cause unnecessary reloads, false negatives cause
///     silently broken filters. Per-expression XML detection is covered by <c>FilterCompilerTests</c>.
/// </summary>
public sealed class RequiresXmlTests
{
    ...
    {
        // Arrange
        var eventFilter = new EventFilter(null, ImmutableList<SavedFilter>.Empty);

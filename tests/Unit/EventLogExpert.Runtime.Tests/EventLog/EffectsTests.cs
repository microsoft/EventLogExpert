...
using CloseAllLogsAction = EventLogExpert.Runtime.Common.Lifecycle.CloseAllLogsAction;
...
public sealed class EffectsTests
{
    ...
    public async Task HandleCloseLog_ShouldRemoveLogAndDispatchCloseAction()
    {
        ...
        mockDispatcher.Received(1).Dispatch(Arg.Is<Runtime.LogTable.CloseLogAction>(a =>
            a.LogId == logId));
    }

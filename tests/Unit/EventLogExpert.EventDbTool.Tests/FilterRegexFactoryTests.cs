...
public sealed class FilterRegexFactoryTests
{
    ...
    public void TryCreate_WhenPatternIsEmpty_ReturnsTrueAndNoRegex()
    {
        ...
        // Act
        var success = FilterRegexFactory.TryCreate(string.Empty, logger, out var regex);
    ...
    public void TryCreate_WhenPatternIsInvalid_ReturnsFalseLogsErrorAndYieldsNullRegex()
    {
        ...
        // Act
        var success = FilterRegexFactory.TryCreate("[unclosed", logger, out var regex);
    ...
    public void TryCreate_WhenPatternIsNull_ReturnsTrueAndNoRegex()
    {
        ...
        // Act
        var success = FilterRegexFactory.TryCreate(null, logger, out var regex);
    ...
    public void TryCreate_WhenPatternIsValid_HasOneSecondMatchTimeout()
    {
        ...
        // Act
        FilterRegexFactory.TryCreate("foo", logger, out var regex);
    ...
    public void TryCreate_WhenPatternIsValid_ReturnsTrueAndCaseInsensitiveRegex()
    {
        ...
        // Act
        var success = FilterRegexFactory.TryCreate("microsoft-windows-.*", logger, out var regex);

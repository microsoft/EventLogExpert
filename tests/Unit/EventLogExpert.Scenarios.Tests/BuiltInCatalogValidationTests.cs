...
public sealed class BuiltInCatalogValidationTests
{
    ...
    public void Catalog_TimelineScenariosMatchExpectedDimensions()
    {
        Dictionary<string, ScenarioTimelineDimension> expected = new(StringComparer.Ordinal)
        {
            ...
            ["lolbin-process-creation-by-name"] = ScenarioTimelineDimension.ProcessImage,
            ...
            ["office-spawned-process"] = ScenarioTimelineDimension.ParentProcessImage,
            ...
            ["sysmon-lolbin-initiated-network"] = ScenarioTimelineDimension.ProcessImage,
